...
class Company(models.Model):
    ...
    def get_default_pk(cls):
        company, created = cls.objects.get_or_create(
            social_name='Freelancer', 
            defaults=dict(name='Freelance', email='freelancer@free.com', city='WFH', found_date='2022-04.06'),
        )
        return company.pk
...
class UserProfile(models.Model):
    ...
    img    = models.ImageField(upload_to='accounts/avatar', blank=True, default='accounts/avatar/blank_profile.png')
